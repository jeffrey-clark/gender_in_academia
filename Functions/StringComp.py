...
if __name__ == "__main__":
    ...
    #s1 = "chicken booger A text of happiness"
    #s2 = "a tept of happines is a text of happiness chicken booger"

    VR  = "(*) Calderón A, Abad JM, Gimeno LA, Marta J, González F, Clerencia M, Poblador B, Poncel A, Prados A. Global health care use by patients with type 2 diabetes: does the type of comorbidity matter? Eur J Intern Med 2015;26(3):203-10. IF: 2.30"
    API = "Global health care use by patients with type-2 diabetes: Does the type of comorbidity matter?"

    API  = "(*) Calderón A, Abad JM, Gimeno LA, Marta J, González F, Clerencia M, Poblador B, Poncel A, Prados A. Global health care use by patients with type 2 diabetes: does the type of comorbidity matter? Eur J Intern Med 2015;26(3):203-10. IF: 2.30"
    VR = "Global health care use by patients with type-2 diabetes: Does the type of comorbidity matter?"
