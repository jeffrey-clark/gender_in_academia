...
#
# This Model conducts the flagging of doc_rows for the docxtractor.py
#
        ...
        section_types = {
            ...
            'Publication':
                [
                    # criterion 1
                    [r'publications*', r'articles*', r'papers*',
                     r'artiklar', r'publikationer', r'original work']  # Taken out: r'journals*'
                ],
