...
class Doc_data:
    def __init__(self):
        ...
        try:
            self.docx_directory = project_root + '/docx_files'
    ...
    def export(self, filename):
        ...
        # export to excel
        writer = pd.ExcelWriter(project_root + "/Spreadsheets/new_docx_analysis/" + filename, engine='xlsxwriter')
...
def extract(researchers, filename, start_id):
    ...
    for vr_r in researchers:
        ...
        #doc_data.match_publications(api_pubs)

        id = id + 1

    print(doc_data.researchers)

    doc_data.export(filename)
...
def main():
    ...
    extract(researchers, filename, start_num)
